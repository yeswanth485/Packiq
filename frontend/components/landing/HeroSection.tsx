...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#185FA5]/10 via-transparent to-[#0A0A0F] pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10 w-full">
        <StaggerContainer className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <StaggerItem>
              <div className="inline-flex items-center gap-2 bg-[#00FFD1]/10 border border-[#00FFD1]/20 px-4 py-2 rounded-full mb-8">
            ...
            <StaggerItem>
              <h1 className="text-6xl md:text-8xl font-bold font-syne tracking-tight mb-8 leading-[1.05] text-white">
                AI-<br />
