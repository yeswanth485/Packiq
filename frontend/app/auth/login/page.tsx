      ...
      <div className="animated-bg min-h-screen flex items-center justify-center p-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">
            ...
            <Link href="/auth/signup" className="text-[#00E5CC] hover:text-[#00c2ad] underline-offset-2 hover:underline">
              Sign up
            </Link>
          </p>
        </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button type="button" onClick={handleForgotPassword} className="text-xs text-[#00E5CC] hover:underline">
                  Forgot Password?
                </button>
              </div>
              <div className="relative">
