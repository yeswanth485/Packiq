...
export async function POST(req: Request) {
  ...
  try {
    ...
    const insertPayload: any = {
      ...
      sku: body.sku || (product_snapshot && product_snapshot.sku) || null,
      product_name: body.product_name || (product_snapshot && product_snapshot.name) || null,
      ...
      fragility_level: body.fragility_level || (product_snapshot && product_snapshot.fragility) || null,
